...
$params=array(
   ...
   //Rating App Store
    ...
    array(
        ...
        'param_name' => 'markers',
        "group" => esc_html__("Images & More", 'waves'),
        'value' => '',
        'params' => array(
            array(
                'type' => 'attach_image',
...
vc_map(array(
    "name" => esc_html__( "Slider Item Monpay", 'waves'),
    "base" => "tw_slider_item_monpay",
    "content_element" => true,
    "as_child" => array('only' => 'tw_slider_monpay'),
    "icon" => "", // Simply pass url to your icon here
    "params" => $params,
));
class WPBakeryShortCode_tw_slider_item_monpay extends WPBakeryShortCode{}